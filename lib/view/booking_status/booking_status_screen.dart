                  ...
                  if (orderlist.isNotEmpty) {
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        DateTime now =
                            DateTime.parse(orderlist[index].datetime);
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        orderlist[index].isadminapproved ==
                                                false
                                            ? "Incomplete"
                                            : "Completed",
                                        style: TextStyle(
                                        ...
                                        child: TimelineTileDemo(
                                            orderModel: OrderModel(
                                                isadminapproved: orderlist[index]
                                                    .isadminapproved,
                                                availabledate: orderlist[index]
                                                    .availabledate,
                                                availabletime: orderlist[index]
                                                    .availabletime,
                                                estimatedetails:
                                                    orderlist[index]
                                                        .estimatedetails,
                                                ...
                                                orderid:
                                                    orderlist[index].orderid,
                                                isDelivered: orderlist[index]
                                                    .isDelivered,
                                                isCanceled:
                                                    orderlist[index].isCanceled,
                                                datetime:
                                                    orderlist[index].datetime,
                                                paymentmethod: orderlist[index]
                                                    .paymentmethod,
                                                userphonenumber:
                                                    orderlist[index]
                                                        .userphonenumber,
